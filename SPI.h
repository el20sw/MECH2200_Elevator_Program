...
//define DRV8711 register values
    ...
    // MODE = 1/4 steps = 0b0010 (default)) - changed to 1/2 steps 0b0001
    // RSTEP = no action = 0b0 (default))
    // DIR = via pin = 0b0 (default)
    // ENBL = Motor disabled = 0b0 (default)
#define DRV_CTRL_REG_VALUE 0b111100001000;

    // From high bits to low bits
    // Reserved bit
    // SMPLTH = 100us 0b001 (default)
    // TORQUE setting = 0x0E (75 mA not default)
#define DRV_TORQUE_REG_VALUE 0x0E
